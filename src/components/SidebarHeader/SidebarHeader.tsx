...
import { Button, Heading, HStack, Text } from '../../core';
  ...
  return (
      <HStack flex={1} alignItems="center" justifyContent="space-between">
        <HStack w="80px" justifyContent="flex-start">
          {!disableNav && <Button variant="ghost" onPress={onOpen} startIcon={<Ionicons name="menu" size={24}/>}/>}
        </HStack>
        ...
        <HStack w="200px" alignItems="center" justifyContent="flex-end">
          ...
          <Button variant="ghost"onPress={doSync}>
            <LottieView
